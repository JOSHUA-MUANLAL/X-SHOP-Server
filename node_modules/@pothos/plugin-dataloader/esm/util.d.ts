...
export declare function loadAndSort<K, V, C, Args = never>(load: (keys: K[], context: C, args: Args) => Promise<readonly (Error | V)[]>, toKey: false | ((val: V) => K) | undefined): ((keys: K[], context: C, args: Args) => Promise<readonly (Error | V)[]>) | ((keys: K[], context: C, args: Args) => Promise<(V | null)[]>);
